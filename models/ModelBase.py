...
class ModelBase(object):
    def __init__(self, is_training=False,
        ...
        self.pretraining_data_path = r'C:\Program Files\DFiles\DF\_internal\pretrain_faces\faceset.pak'
	# r'C:\Program Files\DFiles\DF\_internal\pretrain_faces\faceset.pak'
