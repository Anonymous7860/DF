...
""").lower()
        ...
        if self.is_first_run() or ask_override:
            ...
            self.pretraining_data_path = "/content/pretrain/faceset.pak"
    ...
    def on_initialize(self):
        ...
        with tf.device (models_opt_device):
            ...
            if self.is_training:
                if gan_power != 0:
                    self.D_src = nn.UNetPatchDiscriminator(patch_size=self.options['gan_patch_size'], in_ch=input_ch, base_ch=self.options['gan_dims'], name="D_src")#use_fp16=self.options['use_fp16'], 
